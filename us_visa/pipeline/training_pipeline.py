...
class TrainPipeline:
    ...
    def start_data_validation(
        ...
        logging.info("Entered the start of Data Validation method of Training Pipeline")
        try:
            ...
            logging.info("Performed the data validation opertation")
            logging.info("Exited the start_data_validation method of Training Pipeline")
